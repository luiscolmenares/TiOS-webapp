  ...
  App.controller('AdminDashboardCtrl', ['$scope', 
    ...
    'TriggerService',
    'triggers',
    function ($scope, $localStorage, $window, AuthenticationService, $location, localStorageService, organizations, projects, users, OrganizationService, UserService, ProjectService, DashboardService, TriggerService, triggers) {
