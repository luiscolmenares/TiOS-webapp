...
// App.controller('DashboardCtrl_org', ['$scope', '$localStorage', '$window',
...
// ]);
//Auth Controller
App.controller('MainCtrl', ['$scope', '$http', '$httpParamSerializer', '$cookies',
    function ($scope, $http, $httpParamSerializer, $cookies) {
        $scope.data = {
            grant_type: "password",
            username: "test@test.com",
            password: "test123",
            client_id: "g3b259fde3ed9ff3843839b",
            client_secret: "3d7f5f8f793d59c25502c0ae8c4a95b"
        };
        ...
        $scope.login = function () {
            var req = {
                method: 'POST',
                url: "http://api.dev/api/oauth/access_token",
                headers: {
...
App.controller('WithPromiseCtrl', ['DTOptionsBuilder', 'DTColumnBuilder', '$http', '$q',
    function (DTOptionsBuilder, DTColumnBuilder, $http, $q) {
        var vm = this;
        vm.dtOptions = DTOptionsBuilder.fromFnPromise(function () {
            var defer = $q.defer();
            $http.get('http://api.dev/api/users').then(function (result) {
...
App.controller('TablesDatatablesCtrl', ['$scope', '$localStorage', '$window', '$http',
    function ($scope, $localStorage, $window, $http) {
        ...
        $scope.loadOrganizations = function () {
            ...
            $http.get("http://api.dev/api/organizations")
                    .then(function (response) {
                        console.log(response);
                        $scope.organizationslist = response.data.organizations;
                    });
        ...
        $scope.loadUsers = function () {
            ...
            $http.get("http://api.dev/api/users")
                    .then(function (response) {
                        console.log(response);
        ...
        $scope.loadProjects = function () {
            ...
            $http.get("http://api.dev/api/projects")
                    .then(function (response) {
                        console.log(response);
        ...
        $scope.loadDatasources = function () {
            ...
            $http.get("http://api.dev/api/project/")
                    .then(function (response) {
                        console.log(response);
                        $scope.projectslist = response.data.projects;
                    });
...
App.controller('FormsValidationCtrl', ['$scope', '$localStorage', '$window', 'UserService', 'OrganizationService', 'RoleService', 'ProjectService', 'DatasourceService', '$http', '$state',
    function ($scope, $localStorage, $window, UserService, OrganizationService, RoleService, ProjectService, DatasourceService, $http, $state) {
        ...
        var initValidationBootstrap = function () {
            ...
            $scope.createOrganization = function () {
                ...
                if ($scope.organizationname && $scope.email && $scope.phone && $scope.address)
                {
                    var activation = 0;
                            ...
                            .then(function (response) {
                                ...
                                if (response.success == false) {
                                    ...
                                    if ($scope.selectedOrganization) {
                                        ProjectService.AttachOrganization(response.project.id, $scope.selectedOrganization)
                                                .then(function (response) {
                    ...
                    UserService.Create(user)
                            .then(function (response) {
                                ...
                                if (response.success == false) {
                                    ...
                                    if ($scope.selectedOrganization) {
                                        UserService.AttachOrganization(response.user.id, $scope.selectedOrganization)
                                                .then(function (response) {
                                                    console.log('Organization Attached');
                                                });
                                    }
                                    if ($scope.selectedRole) {
                                        UserService.AttachRole(response.user.id, $scope.selectedRole)
                                                .then(function (response) {
        ...
        var initValidationMaterial = function () {
            jQuery('.js-validation-material').validate({
                ...
                messages: {
                    ...
                    'val-datasourcename2': {
                        required: 'Please enter a datasource',
                        minlength: 'Your datasource must consist of at least 3 characters'
                    },
                    ...
                    'val-org2': 'Please select an organization!',
                    'val-type2': 'Please select an datasource type!',
...
App.controller('FormsWizardCtrl', ['$scope', '$localStorage', '$window', '$state', '$stateParams',
    function ($scope, $localStorage, $window, $state, $stateParams) {
...
//Sample Controller to get Rest Service
